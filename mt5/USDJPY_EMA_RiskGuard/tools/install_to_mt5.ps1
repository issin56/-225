...
$sourceEa = Join-Path $eaDir "USDJPY_EMA_RiskGuard_EA.mq5"
...
$expertDest = Join-Path $mql5Folder "Experts\USDJPY_EMA_RiskGuard"
...
Write-Host "Next: open MetaEditor, compile USDJPY_EMA_RiskGuard_EA.mq5, then restart MT5 or refresh Navigator."
